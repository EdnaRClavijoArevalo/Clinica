...
public class IngresoPacientePresenter {
    ...
    public IngresoPacientePresenter(IngresoPacienteEntity entity) {
        this.id = entity.getId();
        this.idHistoriaClinica = entity.getIdHistoriaClinica();
        this.idDoctorTratante = entity.getIdDoctorTratante();
        this.fechaIngreso = entity.getFechaIngreso();
        this.fechaSalida = entity.getFechaSalida();
    }
